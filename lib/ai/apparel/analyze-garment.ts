import { getGarmentAnalysisPrompt } from "@/lib/workflows/generation/apparel/prompts/analyze-garment";
...
export const garmentAnalysisSchema = z.object({
  gender: z
    .preprocess((v) => {
      ...
      if (["female", "woman", "women", "womens", "f"].includes(s))
        return "female";
      // treat unknown/unisex/other as null for v1
      if (["unisex", "unknown", "other", "n/a", "na", "none"].includes(s))
        return null;
      return null;
...
export async function analyzeGarment(args: {
